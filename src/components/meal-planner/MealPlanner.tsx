...
import { Button as ShoppingListButton } from "@/components/ui/button";
...
export function MealPlanner() {
  ...
  const getMealsForDate = (day: Date, type: 'breakfast' | 'lunch' | 'dinner') => {
    return meals.filter(
      meal => 
  ...
  const openRecipeDialog = (mealType: 'breakfast' | 'lunch' | 'dinner') => {
